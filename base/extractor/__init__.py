...
def extract_text(image):
    img = Image.open(image)  # Load the image into memory
    ocr_result = pytesseract.image_to_string(img)  # Pass the image to pytesseract to be OCRd
    return ocr_result  # Return the results
